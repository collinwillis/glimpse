...
<body>
	...
	<ul>
		<li><img alt="Glimpse" src="{{url('/images/logo.png')}}" height="30px"
			style="margin-top: 10px; margin-left: 10px"></li>
		<li><a class="active" href="{{ route('adminHome') }}">Home</a></li>
		<li><a href="{{ route('adminUser') }}">Admin User Controls</a></li>
		<li><a href="{{ route('adminGroup') }}">Admin Group Controls</a></li>
